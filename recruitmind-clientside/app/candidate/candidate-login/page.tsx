      ...
      <div className="bg-white rounded-3xl shadow-2xl overflow-hidden max-w-4xl w-full flex">
        ...
        <div className="flex-1 p-8 flex flex-col justify-center">
          <div className="max-w-md mx-auto w-full flex flex-col gap-4">
            <h1 className="text-3xl font-bold text-gray-800 mb-2 text-center ">Candidate Login</h1>
            ...
            <div className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-[#18aab8] to-[#2c52bf] text-white py-3 rounded-full font-medium hover:from-[#2c52bf] hover:to-[#18aab8] transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl active:scale-95 transition-transform duration-200"
              >
                Login
              </button>
            </div>
